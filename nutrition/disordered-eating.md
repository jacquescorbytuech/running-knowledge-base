---
type: Concept
title: Disordered eating in runners
description: More common in endurance and lean sports, a spectrum from restriction to clinical eating disorder, and a duty of care for coaches.
...
> [!warning] The route to injury runs through energy availability
> Disordered eating is one of the main ways runners end up in chronic low energy availability, the root cause of [RED-S](red-s.md). That suppresses bone-building hormones and raises [bone stress injury](../injury/bone-stress-injuries.md) rates ([Gallant et al. 2024](../sources/gallant-2024-lea-reds.md)). Recurrent stress fractures, especially at high-risk sites, are a known red flag for an underlying energy and eating problem ([Tenforde et al. 2024](../sources/tenforde-2024-female-bsi.md)).

A runner who keeps fracturing, loses their period, or is repeatedly ill is not simply unlucky. These are downstream signs that often trace back to underfuelling, and the IOC RED-S framework treats disordered eating as a core driver to screen for ([Mountjoy et al. 2023](../sources/mountjoy-2023-ioc-reds.md)).
...
> [!tip] Refer, do not diagnose or police food
> A coach is not a clinician. The role is to notice the pattern, raise it with care, and route the athlete to a sports physician and a registered dietitian, with mental-health support where needed, as the RED-S management pathway sets out ([Mountjoy et al. 2018](../sources/mountjoy-2018-ioc-reds.md)). Comments about weight, public weigh-ins and 'race weight' targets can trigger or worsen the problem and are best avoided.
