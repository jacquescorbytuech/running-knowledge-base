---
type: Concept
title: Daily carbohydrate, protein and energy needs
description: The everyday-diet foundation under all race fuelling, with carbohydrate scaled to training load, enough protein and total energy, and fuelling matched to the work rather than fixed.
tags: [nutrition]
evidence: strong
...
Race-day fuelling gets the attention, but it sits on top of the everyday diet, and that diet is what actually fills the [glycogen](../concepts/glycogen.md) stores, supports adaptation and keeps the body running. The consensus position, from the joint statement of the American College of Sports Medicine, the Academy of Nutrition and Dietetics and Dietitians of Canada, is that there is no single athlete's diet. Intake should be matched to the training being done, day by day, rather than fixed at one set of numbers ([Thomas, Erdman & Burke 2016](../sources/thomas-2016-acsm-nutrition.md)).

## Carbohydrate, scaled to the work

Carbohydrate is the fuel that runs short when the work is hard. The daily target is expressed per kilogram of body mass and scaled to training load ([Thomas, Erdman & Burke 2016](../sources/thomas-2016-acsm-nutrition.md)):
...
Carbohydrate and protein targets only work if total energy intake is adequate. Eat too little overall and the body cannot meet both training and basic function, so it manages the deficit by shutting systems down. This is the concept of energy availability: the energy left after exercise, per kilogram of fat-free mass per day. Below roughly 30 kcal/kg fat-free mass per day, hormonal and other functions are disrupted ([Loucks & Thuma 2003](../sources/loucks-thuma-2003-energy-availability.md)). The threshold is a gradient, not a sharp line, and the exact point varies between people ([Areta et al. 2023](../sources/areta-2023-ea-threshold-review.md)), but the principle holds: chronic underfuelling is the floor below which everything else breaks. Sustained low energy availability is the root cause of [RED-S](red-s.md), with bone, hormones, immunity, [iron](iron.md) status and performance all paying the price ([Thomas, Erdman & Burke 2016](../sources/thomas-2016-acsm-nutrition.md)).

> [!warning] Don't cut fat too low
> Dietary fat should not be slashed in the name of leanness. The consensus advises against dropping below about 20% of energy from fat, because very low-fat diets risk shortfalls in energy, fat-soluble vitamins and essential fatty acids ([Thomas, Erdman & Burke 2016](../sources/thomas-2016-acsm-nutrition.md)). Fat is part of an adequate diet, not the enemy of one.

## Fuel for the work required

Intake should match the demand. The consensus frames the diet as periodised alongside training: more carbohydrate around hard and long sessions, less on easy days, with total energy kept adequate throughout ([Thomas, Erdman & Burke 2016](../sources/thomas-2016-acsm-nutrition.md)). The during-race numbers, given in absolute grams per hour rather than per kilogram, live under [in-race carbohydrate](in-race-carbohydrate.md); the short-term loading protocol before a long race lives under [carbohydrate loading](carbohydrate-loading.md); the rapid-refuelling case sits under [protein and recovery](protein-and-recovery.md). Get the daily diet right first, and those become fine-tuning rather than rescue.

## Related

- [In-race carbohydrate](in-race-carbohydrate.md)
- [Carbohydrate loading](carbohydrate-loading.md)
- [Protein, supplements and recovery nutrition](protein-and-recovery.md)
