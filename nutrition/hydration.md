...
type: Substance
title: Hydration
description: Drink to thirst; overdrinking, not dehydration, is the real danger, and the famous 2% dehydration rule is contested for self-paced running.
tags: [nutrition]
evidence: strong
...
Because the need is set by thirst rather than a schedule, most short road sessions need no fluid carried at all. A [carrier](../gear/hydration-carriers.md) earns its place when refills are scarce and losses are high: long runs, [ultra and trail](../techniques/ultra-and-trail-training.md) events, and hot conditions. The longer and hotter the effort, the more fluid (and the [conditional case for added sodium](electrolytes.md)) matters; the shorter and cooler, the less.
