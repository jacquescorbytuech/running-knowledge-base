...
description: Raising muscle glycogen before long races to delay depletion; effective for events over 90 minutes, with no harsh depletion phase needed for trained runners.
tags: [nutrition]
evidence: strong
...
Carbohydrate loading raises muscle glycogen stores before a long race, delaying the point at which depletion forces a slowdown. The classic 1967 protocol used a depletion phase followed by three days of high carbohydrate intake ([Burke et al. 2011](../sources/burke-2011-fuelling.md)). Trained athletes no longer need the unpleasant depletion phase: 24 to 48 hours of high intake is enough, because their muscles supercompensate readily ([Burke et al. 2011](../sources/burke-2011-fuelling.md)).

The consensus target is roughly 7 to 12 g of carbohydrate per kg of body mass per day for 36 to 48 hours, for events lasting more than about 90 minutes, with around 10 g/kg the commonly cited figure ([Burke et al. 2011](../sources/burke-2011-fuelling.md)). A 2025 meta-analysis suggests the lower end, more than about 8 g/kg/day, may be enough ([Solem et al. 2025](../sources/solem-2025-loading.md)). Loading substantially raises muscle glycogen, though running supercompensates less than cycling ([Solem et al. 2025](../sources/solem-2025-loading.md)).

The benefit is specific to longer events. Higher starting glycogen extends time to exhaustion, and loading improves performance in events long enough to deplete glycogen stores ([Burke et al. 2011](../sources/burke-2011-fuelling.md)). It is the mechanism behind delaying "the wall", the glycogen depletion that typically occurs around 32 km. There is no benefit for events under 90 minutes, and pushing glycogen to extremes brings diminishing returns because higher stores are also burned faster.

## A worked example

> [!example] Loading for a 70 kg runner
