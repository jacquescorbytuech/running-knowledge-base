...
description: Nitrate lowers the oxygen cost of exercise via nitric oxide; a real but modest effect that fades in highly trained runners.
tags: [nutrition]
evidence: moderate
...
Nitrate is converted to nitrite and then to nitric oxide through a pathway that depends on bacteria in the mouth ([McMahon et al. 2017](../sources/mcmahon-2017-nitrate.md)). The effective dose is about 6 to 8 mmol, roughly 350 to 500 mg, in one 70 ml concentrated shot, taken two to three hours before exercise, or daily for several days; more than about 10 to 12 mmol adds nothing.

The effect size is the part the marketing tends to skip. Nitrate is more reliably ergogenic for time to exhaustion than for time-trials, with typical gains around 1 to 3%, and it works best at moderate intensities and in less-trained people ([McMahon et al. 2017](../sources/mcmahon-2017-nitrate.md)). In highly trained endurance athletes the benefit is blunted or absent, a clear example of [individual variation](../concepts/individual-variation.md). Because the conversion depends on oral bacteria, antibacterial mouthwash abolishes the effect, so it should be avoided around dosing.
...
- [Sodium bicarbonate](sodium-bicarbonate.md)
