...
- **Arginine and citrulline "nitric oxide" products.** Weak for endurance, with a 2024 trial showing no running benefit in the heat. These should not be confused with [dietary nitrate](dietary-nitrate.md), which works by a different pathway and does have evidence.
