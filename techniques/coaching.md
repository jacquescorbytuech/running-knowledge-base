...
type: Technique
title: Coaching
description: Working with a running coach versus self-coaching, what a coach actually provides, and the thin evidence isolating a coaching effect.
tags: [training]
evidence: moderate
...
The best-studied part is the coach-athlete relationship, commonly modelled through the 3+1Cs: closeness, commitment, complementarity and shared perceptions ([Jowett 2017](../sources/jowett-2017-coach-athlete.md)). Higher-quality relationships are associated with greater motivation, wellbeing and performance, though the link is stronger for how athletes feel and rate themselves than for objective results. Coach behaviour matters more than the mere presence of a coach: need-supportive coaching predicts greater motivation and wellbeing across cultures ([Jowett et al. 2017](../sources/jowett-2017-motivational-coaching.md)), while controlling, authoritarian coaching is associated with lower motivation and higher burnout ([Mossman et al. 2022](../sources/mossman-2022-autonomy-support-sport.md)).

The case for structure is indirect. Recreational runners frequently misjudge their intensity distribution, spending too much time at a moderate effort that is neither easy nor hard, and a predominantly low-intensity model is the better-evidenced approach ([Boullosa et al. 2020](../sources/boullosa-2020-recreational-runners.md); [polarised training](polarised-training.md)). World-class runners almost all use large easy-volume bases supplemented with threshold and VO2max work ([Haugen et al. 2022](../sources/haugen-2022-elite.md)). A coach is one way to apply that structure, but the inference that a coach is required to get it is an assumption, not a tested result.

## What a coach is for

The value a coach adds is individualisation, objectivity and accountability: a plan fitted to your event, history and life; a check on the urge to do too much; and someone watching training load and early injury signs rather than a generic schedule. That feedback is individual and responsive in a way a [training app](../gear/training-apps.md) is not, since an app applies a generic algorithm to self-tracked metrics that are themselves estimates, while a coach adjusts to the runner in front of them. A coach is most worth it when you want to take your training seriously and get more from it, when your situation is non-standard, when self-regulation is the weak link, or when you are returning from injury and the risk of overdoing it is high.

Online and remote coaching has grown quickly. Remote coaches lean on messaging and software to keep a coaching presence and deliberately build athlete self-regulation, but they flag accountability and adherence risks when supervision is asynchronous ([Blanchfield et al. 2023](../sources/blanchfield-2023-online-coaching.md)). Marketing claims from coaching apps and services are largely self-reported and should be treated as such.

## Credentials and their limits

In the UK a qualified coach holds an England Athletics coaching qualification and a current licence, conditional on a safeguarding module and a valid DBS check ([England Athletics coach licensing](../sources/englandathletics-coaching-licence.md)). The licence verifies a safeguarding and competence floor. It does not certify that a coach individualises well, manages load intelligently or communicates well, and coach quality is highly variable and largely invisible at the point of hiring.

Self-coaching is a legitimate choice, not a fallback. With good information and honest self-assessment, many runners coach themselves successfully; the ingredients a coach supplies, structure, restraint and review, can be self-applied. The questions worth asking before paying for a coach are whether you will follow a plan you did not write, and whether you can be objective about your own training. How any of this works for you is individual ([individual variation](../concepts/individual-variation.md)).

## Related

- [Athletics clubs](athletics-clubs.md)
