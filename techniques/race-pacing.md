...
Elite marathoners run remarkably flat. Analysis of championship marathons found the best runners varied their speed by only about 3% across the whole race, and runners who held an even effort fared better than those who drifted off the pace ([Hanley 2016](../sources/hanley-2016-pacing-profiles.md)). Recreational runners do the opposite. The large majority record positive splits, slowing in the second half, and only a small minority manage a true negative split ([Hanley 2016](../sources/hanley-2016-pacing-profiles.md)). The gap between the two groups is largely a pacing-discipline gap, not only a fitness gap.
