...
type: Technique
title: Hill training
description: Hill reps and short hill sprints build strength, power and economy with lower impact than flat sprinting, with modest controlled evidence behind the economy claim.
tags: [training]
evidence: moderate
...
Hills are most valuable when flat fast running is risky or unavailable: early in a base phase, when returning from injury, or on hilly goal courses. They build the strength and economy that [strength training for runners](strength-training-for-runners.md) and [plyometrics](plyometrics.md) also target, through running-specific movement.

## Related

- [Interval training](interval-training.md)
- [Strength training for runners](strength-training-for-runners.md)
