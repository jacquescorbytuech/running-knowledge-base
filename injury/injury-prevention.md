...
description: A few unglamorous things do most of the work in preventing running injuries: gradual load, strength work, and adequate recovery. Most of the rest is marketing.
tags: [injury]
evidence: moderate
...
Most running injuries are overuse injuries: tissue loaded faster than it could adapt (see [running injuries](running-injuries.md)). An umbrella review of 13 systematic reviews found that running and training characteristics, health and lifestyle factors, and morphological and biomechanical variables carried the largest effect sizes for injury risk — confirming that no single factor dominates and that the problem is genuinely multifactorial ([Correia et al. 2024](../sources/correia-2024-rrmi-umbrella.md)). So most prevention comes down to managing how load is applied and making the tissue more tolerant of it. The honest picture is that very little of what is marketed as injury prevention has been shown to work, and the things that do are dull.
...
- **Static stretching before a run.** It does not prevent overuse injury. The Lauersen meta-analysis found no benefit (relative risk 0.96) ([Lauersen et al. 2014](../sources/lauersen-2014-exercise-prevention.md)), and long pre-exercise static stretches can even blunt strength and power by around 4 to 7.5% ([stretching reviews](../sources/stretching-evidence.md)). A dynamic warm-up is the better default; see [stretching](../recovery/stretching.md).
- **Pronation-control and motion-control shoe prescriptions.** Matching shoes to foot type to prevent injury is not supported. A Cochrane review of 12 RCTs (11,240 runners) found that prescribing shoes by foot posture probably makes little or no difference to injury rates ([Relph et al. 2022](../sources/relph-2022-running-shoes-cochrane.md)). Honest injury-rate trials in footwear are scarce and the clearest recent one was manufacturer-funded with sponsorship-bias concerns ([Footwear Science 2025](../sources/footwear-science-2025-rct.md)). Comfort, not a pronation category, is the sensible basis for choosing shoes.
- **Foam rolling and most gadgets.** Foam rolling produces small, short-lived gains in range of motion and perceived soreness, with negligible effect on muscle function and no demonstrated injury-prevention benefit ([Wiewelhove et al. 2019](../sources/foam-rolling-wiewelhove.md)). It may feel good; that is a different claim from keeping you healthy.

## Running form and cadence

Changing running form to prevent injury is intuitive but thinly evidenced; the fuller picture is on [biomechanics and gait](../concepts/biomechanics-and-gait.md). The popular target of 180 steps per minute is a guideline drawn from elites at race pace, not a universal optimum; cadence rises with pace and the best value is individual ([Marathon Handbook](../sources/marathon-handbook-cadence-myth.md)). A modest cadence increase reduces some joint loads and may help specific problems such as [patellofemoral pain](patellofemoral-pain.md) ([Doyle et al. 2022](../sources/doyle-2022-gait-retraining-meta.md)), but the evidence that prescribing form changes prevents injury in healthy runners is limited to a handful of trials, and overhauling a natural gait can shift load elsewhere. Treat form tweaks as a targeted tool for an existing problem, not a general shield.
...
- [Patellofemoral pain](patellofemoral-pain.md)
