---
type: Technique
title: Soft-tissue therapies (ART, Graston, cupping)
description: Active Release Techniques, instrument-assisted scraping (Graston/IASTM) and cupping are branded soft-tissue treatments resting on weak, inconsistent evidence; the felt benefit matches plain massage more than the branding implies.
tags: [injury]
evidence: weak
...
Cupping applies suction cups to the skin, leaving the circular marks sometimes seen on athletes. A systematic review of its use in musculoskeletal and sports rehabilitation found mostly low-quality, high-risk-of-bias trials; cupping beat doing nothing or usual care, but performed similarly to acupuncture, and the evidence was insufficient to recommend it for athletes ([cupping review 2022](../sources/cupping-2022-review.md)). Adverse effects (skin marking, occasional haematoma or increased pain) are minor. The picture is of a largely non-specific effect on a weak evidence base.

## The common thread

All three sit at the same place as the rest of the [passive therapies](manual-and-passive-therapies.md): real but short-term relief, much of it non-specific, with little to show that the named technique adds anything over plain hands-on work. They are reasonable enough as comfort, poor value as a cure, and not a substitute for the [loading and strength work](../techniques/strength-training-for-runners.md) that treats the injury. The branding is a good example of the [marketing playbook](../nutrition/the-marketing-playbook.md): a proprietary name and a mechanism story attached to a modest, generic effect.
