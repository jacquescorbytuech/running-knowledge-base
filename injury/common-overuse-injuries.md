...
See [plantar fasciopathy](plantar-fasciopathy.md) for the dedicated page. It is pain under the heel, classically sharp with the first steps of the morning. The familiar name 'plantar fasciitis' implies inflammation, but the tissue change is mainly degenerative, which is why 'fasciopathy' is the more accurate term ([Rathleff et al. 2015](../sources/rathleff-2015-plantar.md)).
