---
type: Gear
title: Insoles and orthotics
description: Foot orthoses help some injured runners by changing comfort and load, not by correcting alignment; custom devices rarely beat good prefabricated insoles, and prevention evidence in healthy runners is weak.
tags: [gear, injury]
evidence: limited
...
For some established conditions, orthoses earn a place as part of management. In plantar heel pain they give modest medium-term pain relief, though the effect is small and of uncertain clinical importance ([Whittaker et al. 2018](../sources/whittaker-2018-plantar-orthoses.md)); see [plantar fasciopathy](../injury/plantar-fasciopathy.md). In [patellofemoral pain](../injury/patellofemoral-pain.md), orthoses improve knee function and the ability to play sport but do not reliably reduce pain intensity; physiotherapy and gait retraining outperform them, and orthoses are best used as an add-on to exercise rather than instead of it ([Heliyon 2022](../sources/heliyon-2022-orthoses-pfp.md)).

For preventing injury in runners who are not yet hurt, the evidence is weaker and mixed. A meta-analysis dominated by military-recruit trials found foot orthoses reduced overall injuries and stress fractures, with shock-absorbing insoles showing no such benefit, but trial quality was variable and the populations were not recreational runners ([Bonanno et al. 2017](../sources/bonanno-2017-orthoses-prevention.md)). That signal does not transfer cleanly to a healthy runner deciding whether to buy insoles, and routine prophylactic use is not well supported. This is the same caution applied to orthoses in the wider [overuse-injury picture](../injury/common-overuse-injuries.md).
...
The practical rule that survives the evidence is the comfort filter, the same idea that governs [shoe choice](running-shoes.md): an insole that feels comfortable and reduces symptoms is a reasonable thing to use, while chasing biomechanical "correction" is not. If a cheap insole makes a niggle better, that is a legitimate result on its own terms; if it is uncomfortable, or bought to fix an alignment problem it cannot fix, it is unlikely to help. The device is judged by the individual's response, not by a foot-type chart or a gait-scan readout (see [biomechanics and gait](../concepts/biomechanics-and-gait.md)).

None of this displaces the core of injury management, which is managing load and building tissue capacity through progressive strengthening, the [most reliable lever in the sport](../concepts/the-basics.md). Orthoses are at best an adjunct to that, and at the minimalist end of the spectrum some runners prefer to train the foot directly rather than support it (see [barefoot and minimalist running](barefoot-running.md)).
...
- [Plantar fasciopathy](../injury/plantar-fasciopathy.md)
