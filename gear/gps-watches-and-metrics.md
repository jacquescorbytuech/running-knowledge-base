...
- **Sleep staging.** Wearables detect sleep well but wake poorly, overestimate total sleep time by 20 to 40 minutes, and get light, deep and REM staging substantially wrong ([Schyvens et al. 2025](../sources/schyvens-2025-sleep.md)). Total sleep trend, yes; the stage breakdown, no. See [sleep](../recovery/sleep.md).
