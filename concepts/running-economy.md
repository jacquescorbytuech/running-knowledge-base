...
- **Ground contact time and leg stiffness.** These relate to metabolic cost in a curved fashion, and most trained runners already self-select values within about 5% of their own optimum ([ground-contact and leg-stiffness optimisation study](../sources/gct-leg-stiffness-optimisation.md)). This tempers the popular idea that consciously changing form will easily improve economy: gait is largely self-optimised, so deliberate cueing often costs more than it saves.
