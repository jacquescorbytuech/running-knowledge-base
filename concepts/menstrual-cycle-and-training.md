...
description: The honest state of the evidence: average effects of cycle phase on performance are trivial and the data are weak, so individualise by symptoms.
...
This is the [individual variation](individual-variation.md) problem in sharp form. The group mean describes an average woman who does not exist, while real symptoms vary enormously between people and between cycles.

## What to do instead

Track the cycle alongside training and symptoms, then individualise from the pattern you actually see. If a runner reliably feels flat or sore at a certain point, adjust hard sessions around it for her, not because a chart says so. Treat phase-based prescriptions sold as universal rules with scepticism: the evidence under them is thin, and honest accounts of the field say so plainly ([McNulty et al. 2020](../sources/mcnulty-2020-menstrual-cycle-meta.md)).

The cycle does become a clear warning sign in one direction. Missing periods is not a phase to train around but a red flag for low energy availability and [RED-S](../nutrition/red-s.md), and it warrants attention rather than scheduling.
