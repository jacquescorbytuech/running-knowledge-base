---
type: Concept
title: Early and late developers
description: Why fast early improvers often plateau and slow developers can reach higher ceilings, why junior success poorly predicts senior success, and what that means for patience and talent selection.
tags: [training]
evidence: moderate
...
- **Avoid early specialisation.** Broad, playful, multi-sport development beats narrow early specialisation for long-term outcome and health; the case is set out under [youth and adolescent runners](youth-running.md).
- **Be patient as an adult runner too.** The slow-baker pattern is reassuring for the late starter and the steady improver: distance running rewards years of accumulated [consistent training](the-basics.md), and trainability is [individual](individual-variation.md), so a slow, durable climb often beats a fast early peak. [Masters performance](masters-runners.md) shows how long the runway really is.
...
- [Youth and adolescent runners](youth-running.md)
