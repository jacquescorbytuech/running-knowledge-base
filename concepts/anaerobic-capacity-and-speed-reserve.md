...
ASR also offers a tidier way to set training intensity. Expressing a supramaximal interval as a fraction of a runner's speed reserve, rather than as a fixed percentage of aerobic speed, equalises the physiological demand across athletes with different sprint speeds ([Sandford & Laursen 2021](../sources/sandford-2021-anaerobic-speed-reserve.md)). Much of the prescription evidence so far comes from other sports rather than running, so treat the running application as promising rather than settled ([Sandford & Laursen 2021](../sources/sandford-2021-anaerobic-speed-reserve.md); [Thron et al. 2024](../sources/thron-2024-anaerobic-speed-reserve-assessment.md)). The practical lesson stands: developing maximal speed through short, fast [intervals](../techniques/interval-training.md) raises the ceiling that distance pace sits beneath.
