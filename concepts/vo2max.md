...
The response to identical training varies enormously between people. HERITAGE recorded individual changes from roughly −5% to +48% on the same programme; however, a subsequent meta-analysis of 24 RCTs found that most of this variation is attributable to measurement error rather than genuine biological differences in trainability ([Renwick et al. 2024](../sources/renwick-2024-vo2max-trainability.md)), qualifying the HERITAGE finding ([Bouchard et al., HERITAGE](../sources/heritage-family-study.md)). As much as half of the variation in trainability is heritable, though that ~47% figure is a maximal estimate that sets an upper bound rather than a precise share. This is the clearest single argument for [individual variation](individual-variation.md) in how runners should train. The training that raises VO₂max most is high-intensity work near the ceiling, which is the rationale for [interval training](../techniques/interval-training.md), though volume builds the supporting peripheral adaptations; a large meta-regression found that cumulative training load — volume multiplied by intensity — was the single best predictor of VO₂max gains ([Mølmen et al. 2025](../sources/molmen-2025-mitochondrial-capillary.md)).
